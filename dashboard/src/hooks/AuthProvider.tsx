...
/** Real session state fetched once here, at the root layout, instead of
 * independently by every panel that calls useAuth() — the multi-page
 * redesign turned that redundancy from a minor inefficiency into six
 * separate /api/auth/session calls firing on every single navigation. */
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{ ...auth, loading, signIn, signOut, refresh }}>
      {children}
